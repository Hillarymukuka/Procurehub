...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Side - Dark Gradient with Illustration */}
      <div className="relative hidden w-1/2 flex-col items-center justify-between overflow-hidden bg-gradient-to-br from-primary via-slate-900 to-primary-dark px-16 py-12 lg:flex">
        {/* Decorative circles */}
      ...
      <div className="flex w-full flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-white px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl shadow-slate-900/10">
          {/* Header */}
          <div className="mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <input
                id="email"
                type="email"
                className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3.5 text-sm text-slate-700 placeholder-slate-400 transition focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/20"
                placeholder="Email"
                value={email}
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-secondary to-secondary-dark px-4 py-3.5 text-sm font-semibold text-white shadow-lg shadow-secondary/30 transition hover:shadow-xl hover:shadow-secondary/40 disabled:cursor-not-allowed disabled:opacity-75"
            >
